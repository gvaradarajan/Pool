(function (root) {
  ...
  Pool.MovingObject = function (settings) {
  ...
  Pool.MovingObject.prototype.draw = function (ctx) {
  ...
  Pool.MovingObject.prototype.move = function () {
  ...
  Pool.MovingObject.prototype.bounce = function (bounceX, bounceY) {
    this.vel[0] = bounceX ? -this.vel[0] : this.vel[0];
    this.vel[1] = bounceY ? -this.vel[1] : this.vel[1];
  };

  Pool.MovingObject.getCollisionAngle = function (otherObj) {
